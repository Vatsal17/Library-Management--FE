...
@Component({
  ...
  styleUrls: ['./maintenance.component.scss'], // Fix styleUrl to styleUrls
})
export class MaintenanceComponent {
  ...
  constructor(
    ...
    this.deleteUser = fb.control('', [Validators.required]);
  }
  ...
  deleteExistingUser() {
    let id = this.deleteUser.value; // Get the user ID from the FormControl
